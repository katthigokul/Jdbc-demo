...
public class JdbcBasicDemo {
    ...
    public void displayUser() {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/user", "root", "test");
...
//             PreparedStatement st = connection.prepareStatement("select * from user where name=?", name);
//             st.setString(1,"name");
